...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    // Send notification email to Dinasiri
    const notificationRes = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        ...
        to: ["dinasiriosman1805@gmail.com"],
    ...
    const confirmationRes = await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        from: "Dinasiri Osman <onboarding@resend.dev>",
        to: [email],
        ...
        html: `
          ...
          <p>Best regards,<br>Dinasiri Osman</p>
          <p>
            <a href="mailto:dinasiriosman1805@gmail.com">dinasiriosman1805@gmail.com</a><br>
            +254724465463
          </p>
        `,
      }),
